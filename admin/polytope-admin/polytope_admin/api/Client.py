...
class Client:
    ...
    def __init__(
        ...
        :type user_email: str
        :param password: HTTP 'Basic' authentication assword to be sent
    ...
    @authenticated
    @wraps(Admin.create_user)
    def create_user(self, *args, **kwargs):
        return self.admin.create_user(*args, **kwargs)

    @authenticated
    @wraps(Admin.delete_user)
    def delete_user(self, *args, **kwargs):
        return self.admin.delete_user(*args, **kwargs)
